...
execute as @a[gamemode=spectator] unless entity @s[tag=player] run function rks_extra:judgement
execute as @a[nbt={abilities:{mayfly:1b}}] unless entity @s[tag=player] run function rks_extra:judgement
